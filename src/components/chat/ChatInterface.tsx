    ...
    <div className="flex h-screen flex-col w-[600px]">
      <header className="flex h-16 shrink-0 items-center justify-between border-b bg-card px-4 md:px-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold font-headline">TutorFlow v2</h1>
        </div>
        <DropdownMenu>
      ...
      <footer className="shrink-0 border-t bg-card p-4 space-y-4">
        <div className="relative">
          <Textarea
            ...
            className="pr-20 min-h-[50px] resize-none text-base"
            value={input}
        ...
        <div className="flex justify-center">
            {showPostSurveyButton ? (
                ...
                <AlertDialogTrigger asChild>
                    <Button variant="destructive" className="bg-gray-300 hover:bg-logo-purple text-gray-800 hover:text-white">End Session</Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
