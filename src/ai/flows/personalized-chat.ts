...
const prompt = ai.definePrompt({
 ...
 tutoring for, providing the options of common high school study areas, e.g. Math, English, History, Physics, etc. After the student selects an area, ask them what topic they want tutoring. Once they suggested a topic, ask them at least 5 single-choice questions to test their domain knowledge about that topic.
